...
For details of the upcoming PowerUp 2026 Conference workshop (September 2026), please see [here](https://github.com/frederikgeth/bmopf-report/blob/main/powerup-workshop-agenda.md).
...
A detailed description of the mathematical model is available in the root of this repository. The draft JSON Schema is available at `draft_schema_and_networks/draft_bmopf_schema.json`. Please launch issues to discuss issues with the report. Community-based recommendations and contributions are welcome and encouraged. Please feel free to submit comments and questions in the [issue tracker](https://github.com/frederikgeth/bmopf-report/issues).  All data contributions are subject to a quality assurance review by the repository curator(s).
