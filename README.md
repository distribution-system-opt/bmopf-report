...
A detailed description of the mathematical model is available in the root of this repository. The canonical draft JSON Schema is available at `schema/bmopf.json`; `draft_schema_and_networks/draft_bmopf_schema.json` is kept as a synced copy for existing users. Please launch issues to discuss issues with the report. Community-based recommendations and contributions are welcome and encouraged. Please feel free to submit comments and questions in the [issue tracker](https://github.com/frederikgeth/bmopf-report/issues).  All data contributions are subject to a quality assurance review by the repository curator(s).
